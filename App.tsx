...
import { Zap, Send, Sparkles, TrendingUp } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <main className={`px-4 max-w-7xl mx-auto relative z-10 ${activeTab === 'home' ? '-mt-10' : 'pt-20'}`}>
        ...
        {activeTab === 'home' && (
            <>  
                {/* 1. Top 10 / Trending - First */}
                <TrendingRow movies={top10Movies} onClick={handleMovieClick} />

                {/* 2. Story Circles - Second */}
                {storyMoviesWithBadge.length > 0 && (
                  <div className="mb-8">
